  ...
  return (
    <li className="group aspect-square">
      <NavLink
        to={to}
        className={({ isActive }) =>
          `focus-visible:ring-primary focus-visible:ring-offset-secondary dark:focus-visible:ring-offset-muted flex h-full w-full items-center justify-center rounded-full ${isPicture(user?.profilePicture) ? "p-1" : "p-2"} transition-all duration-300 ease-out group-hover:scale-110 group-active:scale-75 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none ${
