...
function ThemeToggle() {
  ...
  return (
    <div
      className="group text-muted-foreground hover:text-primary relative flex aspect-square w-full cursor-pointer items-center justify-center rounded-full p-2 transition-all duration-300 ease-in-out"
